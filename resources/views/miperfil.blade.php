...
<div class="col-md-8">
					<div class="row">
							...
							<div class="panel panel-default">
							  	...
							  	<div class="panel-body">
								    <div class="row">
								    	...
								    	<div class="col-sm-4">
								    		<form class="form-inline show">    
								    			<!-- hidden / show -->
											  	<div class="form-group">
											    	<input type="text" class="form-control input-sm" id="exampleInputName2" placeholder="Ingresa Nombre">
											  	</div>
								    ...
								    <div class="row">
								    	<div class="col-sm-7">
								    		<strong>Sexo:</strong>
								    		<span class="pull-right">Mujer</span>
								    	</div>
								    	<div class="col-sm-5">
								    		<button class="btn btn-default btn-sm" type="submit">
								    			<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
								    ...
								    <div class="row">
								    	<div class="col-sm-7">
								    		...
								    		<span class="pull-right">Videojuegos, memes, spam ,libros</span>
								    	</div>
								    	<div class="col-sm-5">
								    		<button class="btn btn-default btn-sm" type="submit">
								    			<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
						...
						<div class="col-md-4">
							<div class="thumbnail">
						      	<img src="imagenes/sad-status-1691593_1280.jpg" class="img-responsive img-rounded" alt="Foto perfil">
						      	<div class="caption">
						        	<h3>Jeniffer Lawrence</h3>
						        	<p>
						        		Soy una persona bla Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod, aut!
										<a href="">...ver más</a>
										<button class="btn btn-default btn-sm" type="submit">
							    			<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
								    	</button>
						        	...
						        	<p>
						        		<a href="#" class="btn btn-primary" role="button">Actualizar foto</a> 
						        		<a href="#" class="btn btn-default pull-right" role="button">Borrar foto</a>
						        	</p>
						      	</div>
						    </div>
						</div>
						...
						<div class="col-md-12">
							<div class="panel panel-default">
							  	...
							  	<div class="panel-body">
								    <div class="row">
								    	<div class="col-sm-12">
								    		<h3>Preguntas Hechas<small>(relevancia/fecha)</small></h3>
								    		...
								    		<h3>Respuestas dadas<small>(relevancia/fecha)</small></h3>
