...
var cliente_unicos = new Set(clientearray);
var unArray = [
		{
			"cliente": "Jose Palomino",
    		"cantidad": cellVal_cant,
    		"pedido": ndesa,
    	},
		{
			"cliente": "Alex Cordova",
			"cantidad": cellVal_cant2,
			"pedido": ncena,
		},
	]
